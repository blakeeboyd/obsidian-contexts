...
/**
 * Written while the veil was on: recorded like everything else (the
 ...
 * views' plumbing would break. A future "lift the veil" lens is a one-line
 * change to the read-time gate.
 */
export type Veiled = { veiled?: true };
